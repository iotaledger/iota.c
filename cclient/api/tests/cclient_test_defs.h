...
static tryte_t const *const TEST_BUNDLE_TX_0 =
    (tryte_t *)"L9WDZPYFTAYNGZUYAKQMVIUKOARMNSIBNKCDHGWZLMBQSMDW9BHNFDFNRIUXBEMJWJXYUFFZOOJLA9999";
static tryte_t const *const TEST_BUNDLE_TX_1 =
    (tryte_t *)"NRXNXWDWDVIPIZIN9HKDICKTPLMQLVZZLIIARKPQDLQ9GSUWKNRRSBEHETDKZEHFLOZBGJZII99CA9999";
static tryte_t const *const TEST_BUNDLE_TX_2 =
    (tryte_t *)"HVFBKDJMXYZIEKDYWQW9QWSBXLWGKW9OAAKKTUZSGDUHFZHEBYYIFZBALISVAAKOOJ9LDYIZYDSMA9999";
static tryte_t const *const TEST_BUNDLE_TX_3 =
    (tryte_t *)"USEFBOYXEPUFUKGRIHRBTPCOUEHIZMNMGZAJWFIMYOZBCNOYGMKBVEFIGJDSQJHDWSBLPBUJHJTNA9999";

static tryte_t const *const TEST_MILESTONE_0 =
    (tryte_t *)"LDQPDRMTTDGRGEVMWLGLSMNXOFYZNEAODPRBTDOOWTZMEQRLBVVAYLJANKLYBMHLZIAQAGVKXPCR99999";
