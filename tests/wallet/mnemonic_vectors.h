...
#ifndef __TERST_WALLET_MS_H__
#define __TERST_WALLET_MS_H__

// test vectors: https://github.com/trezor/python-mnemonic/blob/b502451a33a440783926e04428115e0bed87d01f/vectors.json
typedef struct {
  char *ent;   // entropy string
  char *ms;    // mnemonic sentence
  char *seed;  // drive from mnemonic sentence
} ms_vectors_t;

// clang-format off
static ms_vectors_t vectors[] = {
