...
void test_output_alias_without_metadata() {
  ...
  output_alias_t* output =
      output_alias_new(123456789, native_tokens, alias_id, 123456, NULL, 0, 654321, unlock_conds, feat_blocks);
  TEST_ASSERT_NOT_NULL(output);
...
void test_output_alias_without_feature_blocks() {
  ...
  // create alias Output
  output_alias_t* output =
      output_alias_new(123456789, native_tokens, alias_id, 123456, NULL, 0, 654321, unlock_conds, NULL);
  TEST_ASSERT_NOT_NULL(output);
