...
void test_output_alias() {
  ...
  byte_t alias_id[ADDRESS_ALIAS_ID_BYTES];
  iota_crypto_randombytes(alias_id, ADDRESS_ALIAS_ID_BYTES);
  ...
  iota_crypto_randombytes(test_addr.address, ADDRESS_ALIAS_ID_BYTES);
  ...
  // validate alias ID
  TEST_ASSERT_EQUAL_MEMORY(alias_id, output->alias_id, ADDRESS_ALIAS_ID_BYTES);
  ...
  TEST_ASSERT_EQUAL_MEMORY(alias_id, deser_output->alias_id, ADDRESS_ALIAS_ID_BYTES);
...
void test_output_alias_clone() {
  ...
  // compare alias ID
  TEST_ASSERT_EQUAL_MEMORY(alias_id, new_output->alias_id, ADDRESS_ALIAS_ID_BYTES);
  // compare state index
