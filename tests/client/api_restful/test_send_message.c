...
byte_t binary_tag_max_len[TAG_MAX_LEN] = {0x85, 0x59, 0x08, 0x90, 0xbe, 0x39, 0xff, 0xfe, 0x49, 0xab, 0x97, 0x4f, 0x8d,
                                          0x0c, 0x00, 0x35, 0x63, 0xa3, 0x84, 0x78, 0xc5, 0x22, 0xbc, 0x0d, 0x04, 0xf9,
                                          0xd5, 0xd8, 0xd0, 0xc5, 0x97, 0xe2, 0x18, 0x6e, 0xa2, 0x53, 0x52, 0xcd, 0x27,
                                          0x4c, 0x6e, 0x9b, 0x0d, 0x54, 0x25, 0xed, 0x7a, 0xb2, 0xcd, 0x1b, 0x6d, 0x9a,
                                          0x00, 0x7a, 0x25, 0x54, 0x52, 0x9b, 0xdd, 0x35, 0x4c, 0xd2, 0xf8, 0x19};
...
void test_send_core_message_tagged_data_tag_max_len() {
  ...
  // Create tagged data payload
  tagged_data_t* tagged_data = tagged_data_create(binary_tag_max_len, TAG_MAX_LEN, tag_data, TAG_DATA_LEN);
  TEST_ASSERT_NOT_NULL(tagged_data);
  tagged_data_print(tagged_data, 0);
  ...
  // Check if tag in the tagged data payload matches
  TEST_ASSERT_EQUAL_MEMORY(tagged_data_res->tag->data, binary_tag_max_len, TAG_MAX_LEN);
