...
void test_deser_milestone_meta() {
  ...
  int ret = block_meta_deserialize(json_milestone, meta);
  TEST_ASSERT_EQUAL_INT(0, ret);
  TEST_ASSERT_FALSE(meta->is_error);
  TEST_ASSERT_EQUAL_STRING("ebe0c79284d318a1bc36f1d2b6a94ea2ada27a1334d40c565823040131aa1ab4", meta->u.meta->blk_id);
  TEST_ASSERT_EQUAL_INT(5, block_meta_parents_count(meta->u.meta));
  ...
  TEST_ASSERT_EQUAL_STRING("c62ced72c07ca9ec0ba62ef6d0bdd16887411b5d3127d455e36a0b0a5facd7f0",
                           block_meta_parent_get(meta->u.meta, 4));
