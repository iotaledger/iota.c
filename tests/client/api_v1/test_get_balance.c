...
void test_deser_balance_info() {
  ...
  char const* json_info_400 =
      "{\"error\": {"
      "\"code\": \"400\", "
      "\"message\": \"bad request, error: invalid address: 0, error: encoding/hex: odd length hex string: invalid parameter\"}}";
  ...
  TEST_ASSERT_EQUAL_STRING("bad request, error: invalid address: 0, error: encoding/hex: odd length hex string: invalid parameter", res->u.error->msg);
