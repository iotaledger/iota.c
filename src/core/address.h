...
#define ADDRESS_ALIAS_HEX_BYTES (ADDRESS_ALIAS_BYTES * 2)
// A NFT address is the Blake2b-160 hash of the OutputID which created it.
#define ADDRESS_NFT_BYTES 20
#define ADDRESS_NFT_HEX_BYTES (ADDRESS_NFT_BYTES * 2)
#define ADDRESS_FOUNDRY_BYTES 20
#define ADDRESS_FOUNDRY_HEX_BYTES (ADDRESS_FOUNDRY_BYTES * 2)
...
#define BECH32_ENCODED_ED25519_ADDRESS_STR_LEN 64
