 ...
 * @param[in] circ_supply The circulating supply of tokens controlled by this foundry
 * @param[in] max_supply The maximum supply of tokens controlled by this foundry
