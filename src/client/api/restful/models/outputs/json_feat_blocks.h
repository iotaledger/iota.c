...
#ifndef __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_FEAT_BLOCKS_H__
#define __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_FEAT_BLOCKS_H__
...
#endif  // __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_FEAT_BLOCKS_H__
