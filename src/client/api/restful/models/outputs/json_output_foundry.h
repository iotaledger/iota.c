...
#ifndef __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_OUTPUT_FOUNDRY_H__
#define __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_OUTPUT_FOUNDRY_H__
...
#endif  // __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_OUTPUT_FOUNDRY_H__
