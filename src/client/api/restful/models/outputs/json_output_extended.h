...
#ifndef __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_OUTPUT_EXTENDED_H__
#define __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_OUTPUT_EXTENDED_H__
...
#endif  // __CLIENT_API_RESTFUL_MODELS_OUTPUTS_JSON_OUTPUT_EXTENDED_H__
