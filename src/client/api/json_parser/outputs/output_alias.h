...
#ifndef __CLIENT_API_JSON_PARSER_OUTPUTS_OUTPUT_ALIAS_H__
#define __CLIENT_API_JSON_PARSER_OUTPUTS_OUTPUT_ALIAS_H__
...
#endif  // __CLIENT_API_JSON_PARSER_OUTPUTS_OUTPUT_ALIAS_H__
