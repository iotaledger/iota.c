...
static char const* const JSON_KEY_OUTPUT_IDS = "outputIds";
static char const* const JSON_KEY_OUTPUT_IDX = "outputIndex";
static char const* const JSON_KEY_PARENT_IDS = "parentMessageIds";
...
static char const* const JSON_KEY_CM_IDX = "confirmedMilestoneIndex";
static char const* const JSON_KEY_TIMESTAMP = "timestamp";
static char const* const JSON_KEY_UNIXTIME = "unixTime";
static char const* const JSON_KEY_TIP_MSG_IDS = "tipMessageIds";
